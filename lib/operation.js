...
const inject = (arr1, i, arr2) => {
  return arr1.slice(0, i).concat(arr2).concat(arr1.slice(i));
};
...
export const transform = (oper1, oper2) => {
  ...
  for (let i1 = 0; i1 < aOperations1.length; i1++) {
    for (let i2 = 0; i2 < aOperations2.length; i2++) {
      ...
      aOperations1 = inject(aOperations1, i1, aOper1Transformed);
      aOperations2 = inject(aOperations2, i2, aOper2Transformed);
