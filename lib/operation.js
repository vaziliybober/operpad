...
export const combineOperations = (oper1, oper2) =>
  makeOperation(...oper1, ...oper2);
  ...
  for (let i1 = 0; i1 < operations1.length; i1++) {
    for (let i2 = 0; i2 < operations2.length; i2++) {
      ...
      if (o1.length === 1 && o2.length === 1) {
        ...
        operations1[i1] = makeOperation(...a1Transformed);
        operations2[i2] = makeOperation(...a2Transformed);
      } else {
